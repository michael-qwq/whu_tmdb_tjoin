...
public class MapActivity extends Activity implements LocationSource,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button tjoin_button = findViewById(R.id.tjoin_button);
        tjoin_button.setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View v){
                TrajectoryUtils.tjoin();
                drawTrace_tjoin();
            }
        });
    ...
    private void drawTrace(ArrayList<ArrayList<TrajectoryPoint>> trajectories, int draw_type){
        ...
        for(ArrayList<TrajectoryPoint> trajectory : trajectories){
            ...
            for(TrajectoryPoint point : trajectory){
                ...
                //if(path_cnt%2==0) latLngs.add(latLng);
                path_cnt = path_cnt + 1;
    ...
    public void onLocationChanged(AMapLocation amapLocation) {
        ArrayList<TrajectoryPoint> singlepoint = new ArrayList<>();
