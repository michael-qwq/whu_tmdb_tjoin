...
public class TrajectoryUtils {
    ...
    public static void tjoin() {
        try{
            String sql1 = "drop class tjoin";
        ...
        try {
            String sql2 = "create tjoindeputyclass tjoin as select * from mobile_phone_traj intersect select * from watch_traj;";
            CreateTJoinDeputyClassImpl createTJoinDeputyClass = new CreateTJoinDeputyClassImpl(memConnect);
            Statement parse2 = CCJSqlParserUtil.parse(sql2);
            createTJoinDeputyClass.createTJoinDeputyClass(parse2);
        }catch (Exception e){
            e.printStackTrace();
        }
    }
    ...
    public static void save(ArrayList<TrajectoryPoint> trajectory){
        ...
        String uID ="a" + trajectory.get(0).userId;
    ...
    public static ArrayList<ArrayList<TrajectoryPoint>> load_tjoin(){
        ArrayList<ArrayList<TrajectoryPoint>> ret = new ArrayList<ArrayList<TrajectoryPoint>>();
        String sql1 = "SELECT * FROM tjoin;";
        try{
            Select select = new SelectImpl(memConnect);
            Statement parse1 = CCJSqlParserUtil.parse(sql1);
            SelectResult result1 = select.select(parse1);
